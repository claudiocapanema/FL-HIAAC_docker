...
def table(df, write_path, metric, t=None):
    ...
    if t is not None:
        filename = """{}latex_round_auc_general_joint_datasets_{}_{}.txt""".format(write_path, t, metric)
    else:
        filename = """{}latex_auc_general_joint_datasets_{}.txt""".format(write_path, metric)
