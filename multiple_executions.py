...
executions = ["python helpers/generate_docker_compose.py --total_clients=20 --number_of_rounds=100 --strategy='FedYogi' --dataset='CIFAR10' --model='CNN_3' --fraction_fit=0.3 --alpha=0.1 --experiment_id='1_new_clients'",
